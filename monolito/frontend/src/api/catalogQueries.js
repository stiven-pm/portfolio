...
export const MUTATION_MAKE_VARIANT_QUOTE_EFFECTIVE = `
  mutation MakeVariantQuoteEffective($projectId: ID!, $variantId: ID, $variantQuoteId: ID, $effective: Boolean!) {
    makeVariantQuoteEffective(projectId: $projectId, variantId: $variantId, variantQuoteId: $variantQuoteId, effective: $effective)
  }
`;

export const MUTATION_TOGGLE_P3_P5 = `
  mutation ToggleP3P5($projectId: ID!, $variantId: ID, $variantQuoteId: ID) {
    toggleP3P5(projectId: $projectId, variantId: $variantId, variantQuoteId: $variantQuoteId)
  }
`;

export const MUTATION_MARK_VARIANT_AS_DESIGNED = `
  mutation MarkVariantAsDesigned($projectId: ID!, $variantId: ID, $variantQuoteId: ID, $designerId: ID!, $planPdfKey: String) {
    markVariantAsDesigned(projectId: $projectId, variantId: $variantId, variantQuoteId: $variantQuoteId, designerId: $designerId, planPdfKey: $planPdfKey)
  }
`;

export const MUTATION_ASSIGN_VARIANT_TO_USER = `
  mutation AssignVariantToUser($projectId: ID!, $variantQuoteId: ID!, $assigneeId: ID!, $roleType: String!) {
    assignVariantToUser(projectId: $projectId, variantQuoteId: $variantQuoteId, assigneeId: $assigneeId, roleType: $roleType)
  }
`;

export const MUTATION_MARK_VARIANT_AS_DEVELOPED = `
  mutation MarkVariantAsDeveloped($projectId: ID!, $variantId: ID, $variantQuoteId: ID, $developmentUserId: ID!) {
    markVariantAsDeveloped(projectId: $projectId, variantId: $variantId, variantQuoteId: $variantQuoteId, developmentUserId: $developmentUserId)
  }
`;
...
export const MUTATION_REMOVE_VARIANT_FROM_PROJECT = `
  mutation RemoveVariantFromProject($projectId: ID!, $variantId: ID, $variantQuoteId: ID) {
    removeVariantFromProject(projectId: $projectId, variantId: $variantId, variantQuoteId: $variantQuoteId)
  }
`;
